package main.LexicalParser;

import main.Exceptions.LexicalException;
import main.Utilities.FileManager;
import main.Utilities.Keywords;
...
public class LexicalParser {
    ...
    private Token createTokenFor(TypeToken typeToken) {
        if (keywords.isKeyword(lexeme)) {
            typeToken = keywords.getTokenType(lexeme);
        }
        return new Token(typeToken, lexeme, fileManager.line());
    }
    ...
    private Token sEOF() {
        flagEOF = true;
        return createTokenFor(TypeToken.EOF);
    }
    ...
    private Token s1() throws LexicalException {
        ...
        return createTokenFor(TypeToken.LIT_INT);
    }
    ...
    private Token s2() {
        if (Character.isUpperCase(currentChar)
            ...
            return createTokenFor(TypeToken.ID_CLASS);
        }
    }
    ...
    private Token s3() {
        if (Character.isUpperCase(currentChar)
            ...
            return createTokenFor(TypeToken.ID_MET_VAR);
        }
    }
    ...
    private Token s13() {
        updateLexeme();
        updateCurrentChar();
        return createTokenFor(TypeToken.LIT_CHAR);
    }
    ...
    private Token s10() {
        return createTokenFor(TypeToken.LIT_STRING);
    }

    private Token s11() {
        return createTokenFor(TypeToken.BRACES_OPEN);
    }

    private Token s12() {
        return createTokenFor(TypeToken.BRACES_CLOSE);
    }

    private Token s14() {
        return createTokenFor(TypeToken.PARENTHESES_OPEN);
    }

    private Token s15() {
        return createTokenFor(TypeToken.PARENTHESES_CLOSE);
    }

    private Token s16() {
        return createTokenFor(TypeToken.COMMA);
    }

    private Token s17() {
        return createTokenFor(TypeToken.SEMICOLON);
    }

    private Token s18() {
        return createTokenFor(TypeToken.DOT);
    }
    ...
    private Token s19() {
        ...
        return createTokenFor(TypeToken.GREATER);
    }

    private Token s20() {
        return createTokenFor(TypeToken.GREATER_EQUALS);
    }
    ...
    private Token s21() {
        ...
        return createTokenFor(TypeToken.LESS);
    }

    private Token s22() {
        return createTokenFor(TypeToken.LESS_EQUALS);
    }
    ...
    private Token s23() {
        ...
        return createTokenFor(TypeToken.OP_NOT);
    }

    private Token s24() {
        return createTokenFor(TypeToken.NOT_EQUALS);
    }
    ...
    private Token s25() {
        ...
        return createTokenFor(TypeToken.ASSIGN);
    }

    private Token s26() {
        return createTokenFor(TypeToken.EQUALS);
    }
    ...
    private Token s27() {
        ...
        return createTokenFor(TypeToken.ADD);
    }

    private Token s28() {
        return createTokenFor(TypeToken.ASSIGN_ADD);
    }
    ...
    private Token s29() {
        ...
        return createTokenFor(TypeToken.SUB);
    }

    private Token s30() {
        return createTokenFor(TypeToken.ASSIGN_SUB);
    }

    private Token s31() {
        return createTokenFor(TypeToken.MULTIPLY);
    }
    ...
    private Token s32() throws LexicalException {
        ...
        return createTokenFor(TypeToken.DIVIDE);
    }
    ...
    private Token s38() {
        return createTokenFor(TypeToken.OP_AND);
    }
    ...
    private Token s40() {
        return createTokenFor(TypeToken.OP_OR);
    }

    private Token s41() {
        return createTokenFor(TypeToken.MOD);
    }
